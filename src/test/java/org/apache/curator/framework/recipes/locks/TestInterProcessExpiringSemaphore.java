...
public class TestInterProcessExpiringSemaphore extends BaseClassForTests
{
    ...
    public void testThreadedLeaseIncrease() throws Exception
    {
        ...
        try
        {
            ...
            final SharedCount timeToLiveCount = new SharedCount(client, "/foo/ttl", 10000);
            timeToLiveCount.start();

            final InterProcessExpiringSemaphore semaphore = new InterProcessExpiringSemaphore(client, "/test", count, timeToLiveCount, CreateMode.EPHEMERAL_SEQUENTIAL);
    ...
    public void testClientClose() throws Exception
    {
        ...
        InterProcessExpiringSemaphore semaphore1;
        InterProcessExpiringSemaphore semaphore2;
        try
        {
            ...
            final SharedCount timeToLiveCount1 = new SharedCount(client1, "/foo/ttl", 10000);
            timeToLiveCount1.start();

            final SharedCount timeToLiveCount2 = new SharedCount(client1, "/foo/ttl", 10000);
            timeToLiveCount2.start();
            
            semaphore1 = new InterProcessExpiringSemaphore(client1, "/test", 1, timeToLiveCount1, CreateMode.EPHEMERAL_SEQUENTIAL);
            semaphore2 = new InterProcessExpiringSemaphore(client2, "/test", 1, timeToLiveCount2, CreateMode.EPHEMERAL_SEQUENTIAL);
                            ...
                            new Callable<Object>()
                            {
                                ...
                                public Object call() throws Exception
                                {
                                    ...
                                    try
                                    {
                                        ...
                                        InterProcessExpiringSemaphore semaphore = new InterProcessExpiringSemaphore(client, "/test", SESSION_MAX, timeToLiveCount, CreateMode.EPHEMERAL_SEQUENTIAL);
                    ...
                    new Callable<Object>()
                    {
                        ...
                        public Object call() throws Exception
                        {
                            ...
                            try
                            {
                                ...
                                InterProcessExpiringSemaphore semaphore = new InterProcessExpiringSemaphore(client, "/test", MAX, timeToLiveCount, CreateMode.EPHEMERAL_SEQUENTIAL );
                    ...
                    (
                        new Callable<Object>()
                        {
                            ...
                            public Object call() throws Exception
                            {
                                ...
                                InterProcessExpiringSemaphore semaphore = new InterProcessExpiringSemaphore(client, "/test", MAX_LEASES ,timeToLiveCount, CreateMode.EPHEMERAL_SEQUENTIAL);
                                Lease lease = semaphore.acquire(timing.forWaiting().seconds(), TimeUnit.SECONDS);
                                if ( lease == null )
                                {
    ...
    public void testThreads() throws Exception
    {
        ...
        try
        {
            ...
            final InterProcessExpiringSemaphore semaphore = new InterProcessExpiringSemaphore(client, "/test", 1 ,timeToLiveCount, CreateMode.EPHEMERAL_SEQUENTIAL);
    ...
    public void testSimple() throws Exception
    {
        ...
        try
        {
        	// set timeout to be two times as long as the wait time
            final SharedCount timeToLiveCount = new SharedCount(client, "/foo/ttl", timing.forWaiting().multiple(2).milliseconds());
            timeToLiveCount.start();
            
            InterProcessExpiringSemaphore semaphore = new InterProcessExpiringSemaphore(client, "/test", 1 ,timeToLiveCount, CreateMode.EPHEMERAL_SEQUENTIAL);
    ...
    @Test
    public void testSimpleExpiring() throws Exception
    {
        Timing timing = new Timing();
        CuratorFramework client = CuratorFrameworkFactory.newClient(server.getConnectString(), timing.session(), timing.connection(), new RetryOneTime(1));
        client.start();
        try
        {
        	// set timeout to be half of waiting time so second acquire does not time out
            final SharedCount timeToLiveCount = new SharedCount(client, "/foo/ttl", timing.forWaiting().multiple(.5).milliseconds());
            timeToLiveCount.start();
    ...
    public void testSimple2() throws Exception
    {
        ...
        try
        {
            final SharedCount timeToLiveCount = new SharedCount(client, "/foo/ttl", timing.forWaiting().multiple(MAX_LEASES).milliseconds());
            timeToLiveCount.start();
    ...
    @Test
    public void testSimple2Expiring() throws Exception
    {
        final int MAX_LEASES = 3;
        Timing timing = new Timing();
        ...
        try
        {
            final SharedCount timeToLiveCount = new SharedCount(client, "/foo/ttl", timing.forWaiting().multiple(1.5).milliseconds());
            timeToLiveCount.start();
            ...
            InterProcessExpiringSemaphore semaphore2 = new InterProcessExpiringSemaphore(client, "/test", MAX_LEASES,timeToLiveCount, CreateMode.EPHEMERAL_SEQUENTIAL);
            Lease lease2 = semaphore.acquire(timing.forWaiting().seconds(), TimeUnit.SECONDS);
    ...
    public void testGetParticipantNodes() throws Exception
    {
        ...
        try
        {
            ...
            InterProcessExpiringSemaphore semaphore = new InterProcessExpiringSemaphore(client, "/test", LEASES ,timeToLiveCount, CreateMode.EPHEMERAL_SEQUENTIAL);
    ...
    public void testChildReaperCleansUpLockNodes() throws Exception
    {
        ...
        try
        {
            ...
            InterProcessExpiringSemaphore semaphore = new InterProcessExpiringSemaphore(client, "/test/lock", 1 ,timeToLiveCount, CreateMode.EPHEMERAL_SEQUENTIAL );
            ...
            childReaper = new ChildReaper(
                    ...
                    1,
                    "/test-leader",
                    InterProcessExpiringSemaphore.LOCK_SCHEMA
            );
            childReaper.start();
